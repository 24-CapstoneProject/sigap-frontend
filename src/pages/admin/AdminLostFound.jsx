...
function ItemCard({ item, onApprove, onReject, isAdmin }) {
      ...
      <div className="p-4 bg-white">
        ...
        {isAdmin && (
          <div className="mt-3 pt-3 border-t border-gray-50 flex gap-2">
            <Button variant="success" size="sm" className="flex-1 justify-center text-xs" onClick={() => onApprove(item.id)}>
              ✓ Terima
            </Button>
            <Button variant="danger" size="sm" className="flex-1 justify-center text-xs" onClick={() => onReject(item.id)}>
              ✕ Tolak
            </Button>
          </div>
        )}
